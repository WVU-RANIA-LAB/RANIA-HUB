                        ...
                        <div className="flex-grow bg-white border-2 border-black">
                            ...
                            <div className="pt-5 pl-5">
                                <div className="overflow-hidden">
                                    ...
                                    <span className="block underline text-blue-900 text-base font-bold">Project Description: </span><span>{projectInfo[0].description}</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div className="w-full p-2">
          <div className="flex flex-col h-full min-h-80 overflow-hidden">
            <div className="flex-grow bg-white border-2 border-black">
              ...
              <div className='p-5'>
                <p>Build the dashboard here for your RANIA device. Clicking "Save" will save the current formatted dashboard to your project, and generate a handshake packet that your device should sent to the hub to connect to it.</p>                        
              </div>
              <div style={{ padding: 5,display: 'flex', justifyContent: 'center' }}>
                <ProjectDashboard projectId={projectInfo[0].id} projectName={projectInfo[0].name} projectDescription={projectInfo[0].description}/>
              </div>
            </div>
          </div>
        </div>
