...
export default async function ProjectTesting() {
  ...
  const groupNumber = session!.user!.group!
    ...
    return <main className="flex-grow flex flex-col bg-white px-2 py-8 sm:px-10 sm:py-20">
          ...
          <div className="flex flex-col overflow-hidden">
              <div className="flex-grow bg-white border-2 border-black">
                  <div className="flex items-center justify-between w-full h-12 bg-wvu-primary-blue pl-5 pr-5">
                      <h6 className={`${lusitana.className} rounded-md bg-wvu-primary-blue p-2 text-lg uppercase text-white antialiased`}>Test Project Functionality</h6>
                  </div>
                  <div className="pt-5 pl-5">
                        <ProjectTestDashboard projectId={projectInfo[0].id} projectName={projectInfo[0].name} projectDescription={projectInfo[0].description}/>
